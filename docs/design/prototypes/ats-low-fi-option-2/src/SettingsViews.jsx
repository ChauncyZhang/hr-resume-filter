...
function deletionStatusLabel(status) {
  return ({ requested: "待审批", approved: "已批准", queued: "已排队", processing: "处理中", completed: "已完成", failed: "失败" })[status] || status || "未知";
}
